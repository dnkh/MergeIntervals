...
namespace MergeInterval
{
    ...
    {
        [Option('c', "csv", Required = false, Group= "IntervalSource", HelpText = "Read intervals from the specified csv file.Caution filename has to be enclosed with quotation marks")]
